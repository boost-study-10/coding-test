...
1분마다 위의 두가지를 반복해야한다.
따라서 각각 queue를 두고
각각의 queue의 현재 크기만큼이 1분동안 실행되어야할 작업이므로 queue.size() 만큼 물 확장과 고슴도치 이동을 진행한다.

물이 더 이상 퍼질 곳이 없더라도 고슴도치는 계속 움직여야 함
메인 루프는 **고슴도치가 움직일 수 있을 때까지**(!sQueue.isEmpty()) 돌기
...
![](https://velog.velcdn.com/images/seha01130/post/e71fbb49-5c75-4a4b-913a-b99547f2d80c/image.png)
